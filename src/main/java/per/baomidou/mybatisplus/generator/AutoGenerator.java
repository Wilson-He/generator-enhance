...
public class AutoGenerator {
     ...
     * 注入配置
     */
    protected AbstractInjectionConfig abstractInjectionConfig;
    /**
     * 数据源配置
     */
    ...
    public void execute() {
        ...
        if (null == config) {
            ...
            if (null != abstractInjectionConfig) {
                abstractInjectionConfig.setConfig(config);
            }
        }
    ...
    protected ConfigBuilder pretreatmentConfigBuilder(ConfigBuilder config) {
        ...
        if (null != abstractInjectionConfig) {
            ...
            config.setAbstractInjectionConfig(abstractInjectionConfig);
        }
        /**
         * 表信息列表
         */
    ...
    public AbstractInjectionConfig getCfg() {
        return abstractInjectionConfig;
    }

    public AutoGenerator setCfg(AbstractInjectionConfig abstractInjectionConfig) {
