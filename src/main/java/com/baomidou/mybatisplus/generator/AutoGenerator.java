...
public class AutoGenerator {
        ...
        for (TableInfo tableInfo : tableList) {
            ...
            if (config.getStrategyConfig().isEntityBooleanColumnRemoveIsPrefix()) {
                tableInfo.getFields().stream()
                        ...
                        .forEach(field -> field.setConvert(true)
                                .setPropertyName(StringUtils.removePrefixAfterPrefixToLower(field.getPropertyName(), 2)));
            }
        }
    ...
    public AutoGenerator setCfg(InjectionConfig injectionConfig) {
        this.injectionConfig = injectionConfig.setAutoGenerator(this);
        return this;
    }

    public AutoGenerator setDataSource(DataSourceConfig dataSource) {
        this.dataSource = dataSource.setAutoGenerator(this);
        return this;
    }

    public AutoGenerator setStrategy(StrategyConfig strategy) {
        this.strategy = strategy.setAutoGenerator(this);
        return this;
    }

    public AutoGenerator setPackageInfo(PackageConfig packageInfo) {
        this.packageInfo = packageInfo.setAutoGenerator(this);
        return this;
    }
    ...
    public AutoGenerator setGlobalConfig(GlobalConfig globalConfig) {
        this.globalConfig = globalConfig.setAutoGenerator(this);
        return this;
    }
